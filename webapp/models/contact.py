...
class Contact(models.Model):
    ...
    udf01 = models.CharField(
        max_length=30, default=None, null=True, blank=True)
    udf02 = models.CharField(
        max_length=30, default=None, null=True, blank=True)
    udf03 = models.CharField(
        max_length=30, default=None, null=True, blank=True)
    udf04 = models.CharField(
        max_length=30, default=None, null=True, blank=True)
    udf05 = models.CharField(
        max_length=30, default=None, null=True, blank=True)
    udf06 = models.CharField(
        max_length=30, default=None, null=True, blank=True)
    udf07 = models.CharField(
        max_length=30, default=None, null=True, blank=True)
    udf08 = models.CharField(
        max_length=30, default=None, null=True, blank=True)
    udf09 = models.CharField(
        max_length=30, default=None, null=True, blank=True)
    udf010 = models.CharField(
        max_length=30, default=None, null=True, blank=True)
...
# query set to fetch the contact_type
contact_type = str(ContactForm.objects.all())
...
def calculate_score_matrix(sender, instance, **kwargs):
    ...
    if 'HR' in contact_type:
        instance.score_matrix = hr(instance)
    if 'Biz' in contact_type:
        instance.score_matrix = biz(instance)
